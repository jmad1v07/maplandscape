#' Add layer to \code{Leaflet} web map with a legend
#'
...
add_layers_leaflet_legend <- function(map_object, map_active_df, map_var, map_colour, opacity, map_line_width, map_line_colour, waiter) {
