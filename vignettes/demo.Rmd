...
```{r, echo = FALSE, fig.align = "center", out.width = "85%", fig.cap = "Source:  Bégué et al. (2018)"}
knitr::include_graphics("cropping-systems.png")

```
<center>
![Source:  Bégué et al. (2018)](cropping-systems.png){width="95%"}
</center>
